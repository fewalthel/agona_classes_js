...
const getProducts = () => getAsync(products);
const getUsers = () => getAsync(users);
const getCompanies = () => getAsync(companies);
const getReviews = () => getAsync(reviews);

module.exports = {getProducts, getUsers, getCompanies, getReviews};